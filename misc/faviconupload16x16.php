...
$filename = pathinfo($_FILES['16x16png']['name'], PATHINFO_FILENAME);
$extension = strtolower(pathinfo($_FILES['16x16png']['name'], PATHINFO_EXTENSION));
...
if ($_FILES['16x16png']['size'] > $max_size) {
...
if (function_exists('exif_imagetype')) { //Die exif_imagetype-Funktion erfordert die exif-Erweiterung auf dem Server
    ...
    $detected_type = exif_imagetype($_FILES['16x16png']['tmp_name']);
...
$new_path = $upload_folder . 'favicon16x16' . '.' . $extension;

move_uploaded_file($_FILES['16x16png']['tmp_name'], $new_path);
